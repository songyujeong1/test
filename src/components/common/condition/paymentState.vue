...
<div class="col-md-1" :style="getStyle()">
  <div class="form-group">
    <label>결제상태</label>
    <el-select v-model="value.paymentState" placeholder="전체" size="small" @change="onHandleDataChange" clearable>
...
export default {
  ...
  mounted() {
    if (this.isInitializeValue === true && this.field && this.field.defaultValue) {
      Object.assign(this.value, {paymentState: this.field.defaultValue});
    }
