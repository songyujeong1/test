<template>
  <div class="col-md-2" :style="getStyle()">
    <div class="form-group">
      <label>오류/불일치 상세</label>
      <el-select v-model="value.errorDetailState" placeholder="전체" size="small" @change="onHandleDataChange" clearable>
...
export default {
  ...
  methods: {
    async initializeComponent() {
      this.options = await this.getDetailCodeListAsync('9210');
